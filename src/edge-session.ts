 ...
 *
 * @param secret - Session secret (optional, uses ADAPT_AUTH_SESSION_SECRET env var)
 * @param cookieName - Cookie name (optional, uses ADAPT_AUTH_SESSION_NAME env var)
 ...
 * const sessionCookie = cookies['adapt-auth-session'];
 *
 * if (sessionCookie) {
